...
<body>
    ...
    <hr>
    <textarea id="val" oninput="save();" style="max-width:100%; min-height:<?= count(file("paste.txt")) ?>pc; height:100%; width:100%;" spellcheck="false"><?= htmlspecialchars(file_get_contents("paste.txt")) ?></textarea>
